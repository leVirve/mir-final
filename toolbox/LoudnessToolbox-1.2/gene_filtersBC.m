...
if strcmp(show, 'yes'),
    ...
    subplot(614), plot(t, sigFiltEch(:,19)); ylabel('4500 Hz');
        axis([ax(1) ax(2) ymin ymax]);
    subplot(615), plot(t, sigFiltEch(:,14)); ylabel('2100 Hz');
        axis([ax(1) ax(2) ymin ymax]);
    subplot(616), plot(t, sigFiltEch(:,8)); ylabel('850 Hz');
        axis([ax(1) ax(2) ymin ymax]);
    subplot(616), plot(t, sigFiltEch(:,2)); ylabel('150 Hz');
        axis([ax(1) ax(2) ymin ymax]);
    ...
    subplot(614), plot(t, sigFilt(:,19)); ylabel('4500 Hz');
        axis([ax(1) ax(2) ymin ymax]);
    subplot(615), plot(t, sigFilt(:,14)); ylabel('2100 Hz');
        axis([ax(1) ax(2) ymin ymax]);
    subplot(616), plot(t, sigFilt(:,8)); ylabel('850 Hz');
        axis([ax(1) ax(2) ymin ymax]);
    subplot(616), plot(t, sigFilt(:,2)); ylabel('150 Hz');
        axis([ax(1) ax(2) ymin ymax]);
