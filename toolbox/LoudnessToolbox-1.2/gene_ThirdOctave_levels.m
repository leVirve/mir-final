function [MatNiv Fc Time] = gene_ThirdOctave_levels(sig, fe, deltaT, P0)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [MatNiv Fc Time] = gene_ThirdOctave_levels(son,fe, deltaT, P0)
%
% FUNCTION
...
%       fe = fréquence d'échantillonnage (scalaire)
%       deltaT = pas de temps en secondes pour le calcul des niveaux (optionnel, 0.5 par défaut)
%                (=longueur de fenêtre sur laquelle on calcule les niveaux)
%       P0 = pression de réf. (optionnel, 2e-5 par défaut)
% 
% SORTIES
%       MatNiv= Matrice contenant les niveaux dans les 29 bandes de tiers d'octave
%               en ligne, et fenêtres temporelles de deltaT secondes en
%               colonnes
%       Fc    = fréquences centrales des bandes de tiers d'octave (Hz)
%       Time  = temps (s) central des fenêtres
%               
%
% 
% Les filtres tiers d'octave utilisés ici sont issus du programme de base de
% Christophe Couvreur, modifié par Aaron Hastings, Herrick Labs, de Purdue
% University afin d'avoir une meilleure précision BF par un sous-échantillonage 
% Voir http://www.mathworks.com/matlabcentral/
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% get IIR filters
Nbandes = 29;
StructFilt = gene_ThirdOctave_Filters(fe); % structure of IIR for each band
