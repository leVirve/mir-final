function [B,A] = gene_oct3dsgn(Fc,Fs,N)

% OCT3DSGN  Design of a one-third-octave filter.
%    [B,A] = GENE_OCT3DSGN(Fc,Fs,N) designs a digital 1/3-octave filter with 
...
%
% renamed gene_oct3dsgn by Genesis for the purpose of the loudness toolbox
%
